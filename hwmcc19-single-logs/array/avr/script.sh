...
#SBATCH -c 32
#SBATCH -a 1-312
#SBATCH -D /home/mathias/hwmcc19/hwmcc19-final-avr-rerun/20191018-avr

benchmarks="/home/mathias/hwmcc19/hwmcc19-final-avr-rerun/20191018-avr/btor_array_hwmcc19/benchmarks"
...
# set stdout log file
log="/home/mathias/hwmcc19/hwmcc19-final-avr-rerun/20191018-avr/btor_array_hwmcc19/${out}.log"
# set stderr log file
err="/home/mathias/hwmcc19/hwmcc19-final-avr-rerun/20191018-avr/btor_array_hwmcc19/${out}.err"

export BENCHMARK
(
  RUNLIM_BIN="/home/mathias/bin/runlim"
  RUNLIM_OPTS="--real-time-limit=3600 --space-limit=120000"
  SOLVER_BIN="./run-avr.sh"
  SOLVER_OPTS=""
  SCRAMBLER=""
